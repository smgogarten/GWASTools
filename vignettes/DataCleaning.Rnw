...
using the \Rpackage{SNPRelate} package.
...
the function \Rcode{gdsSetMissingGenotypes} to create a new GDS file
...
gdsSetMissingGenotypes(genofile, subj.filt.file, anom.filt, sample.include=subj)
