...
author:
  - name: "GENEVA"
    affiliation: "Coordinating Center Department of Biostatistics University of Washington"
...
recommend calling Affymetrix genotypes "by.plate" (in which case the `
plate.name` argument is passed to the function). For more detail regarding the
